    ...
    <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4 z-10">
      ...
      <div className="flex items-center justify-between pointer-events-auto">
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-2 px-3 py-1.5 bg-surface-900/80 backdrop-blur-md rounded-xl border border-surface-800 shadow-lg text-xs font-semibold text-surface-200">
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-1 p-1 bg-surface-900/80 backdrop-blur-md rounded-xl border border-surface-800 shadow-lg">
      ...
      <div className="flex items-end justify-between pointer-events-auto">
        <button
          ...
          className={`flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-semibold backdrop-blur-md border transition-all duration-200 shadow-xl ${
            isTurntableActive
        ...
        >
          ...
          <span>{isTurntableActive ? 'Turntable Spinning' : '360° Auto Spin'}</span>
        </button>
